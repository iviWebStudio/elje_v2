...
const withDefaultAttributes = createHigherOrderComponent(
	(BlockListBlock) => {
		class WrappedComponent extends Component {
			...
			componentDidUpdate() {
				if (
					this.props.block.name.startsWith('elje/') &&
					!this.mounted
				) {
					this.mounted = true;
				}
 ...
 *
 * To use this, the block name needs a `elje/` prefix, and as well

...
import BlockErrorBoundary
	from "@elje/base-components/block-error-boundary";
...
// the event `elje-blocks_render_blocks_frontend` to render its inner blocks.
const selectorsToSkipOnLoad = ['.wp-block-elje-skip-render'];

type BlockProps<TProps extends Record<string, unknown>,
...
type BlockType<TProps extends Record<string, unknown>,
	TAttribute extends Record<string, unknown>> = (props: BlockProps<TProps, TAttribute>) => JSX.Element | null;

export type GetPropsFn<TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>> = (el: HTMLElement, i: number) => BlockProps<TProps, TAttributes>;

interface RenderBlockParams<TProps extends Record<string, unknown>,
 ...
 */
export const renderBlock = <TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>>({
													 Block,
													 container,
	...
	render(
		<BlockErrorBoundary {...errorBoundaryProps}>
			<Suspense fallback={
				<div className="elje-block-placeholder"/>}>
				{Block &&
...
interface RenderBlockInContainersParams<TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>> {
	// React component to use as a replacement.
	Block: BlockType<TProps, TAttributes> | null;
 ...
 */
const renderBlockInContainers = <TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>>({
													 Block,
													 containers,
...
interface RenderBlockOutsideWrappersParams<TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>> extends RenderFrontendParams<TProps, TAttributes> {
 ...
 */
const renderBlockOutsideWrappers = <TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>>({
													 Block,
													 getProps,
													 getErrorBoundaryProps,
...
interface RenderBlockInsideWrapperParams<TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>> extends RenderFrontendParams<TProps, TAttributes> {
 ...
 * wrapper element.
 */
const renderBlockInsideWrapper = <TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>>({
													 Block,
													 getProps,
													 getErrorBoundaryProps,
...
interface RenderFrontendParams<TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>> {
	// React component to use as a replacement.
	Block: BlockType<TProps, TAttributes> | null;
 ...
 * `elje-blocks_render_blocks_frontend` event is triggered.
 */
export const renderFrontend = <TProps extends Record<string, unknown>,
	TAttributes extends Record<string, unknown>>(
	props:
	...
	Array.prototype.forEach.call(wrappersToSkipOnLoad, (wrapper) => {
		wrapper.addEventListener('elje-blocks_render_blocks_frontend', () => {

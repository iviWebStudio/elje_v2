...
import SnackbarNoticesContainer
	from './components/snackbar-notices-container';

/**
 * @typedef {import('@elje/type-defs/contexts').NoticeContext} NoticeContext
 * @typedef {import('react')} React
 */

const StoreSnackbarNoticesContext = createContext({
	notices: [],
	createSnackbarNotice: (content, options) => void {
		content,
		options,
	},
	removeSnackbarNotice: (id, ctxt) => void {
		id,
		ctxt,
	},

 ...
 */
export type GeneratorReturnType<T extends (...args: any[]) => Generator> = T extends (...args: any) => Generator<any, infer R, any> ? R : never;
 ...
 */
export type ReturnOrGeneratorYieldUnion<T extends (...args: any) => any> = T extends (...args: any) => infer Return

...
import {ELJE_BLOCKS_PHASE} from './constants';
 ...
 */
export const isExperimentalBuild = (): boolean => ELJE_BLOCKS_PHASE > 2;
 ...
 */
export const isFeaturePluginBuild = (): boolean => ELJE_BLOCKS_PHASE > 1;
